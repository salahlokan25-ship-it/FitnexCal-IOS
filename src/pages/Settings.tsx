          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold">
                    {getCurrentPlan() === 'Free' ? '$0.00' : 'Premium'}
                  </div>
                  <div className="text-sm text-gray-400">
                    {getCurrentPlan() === 'Free' ? 'forever' : 'active'}
                  </div>
                </div>
              </div>
            ...
            {getCurrentPlan() === 'Free' && (
              <div className="bg-gray-800 p-8 rounded-lg text-center">
                <h4 className="font-semibold text-xl mb-4">Upgrade to Premium</h4>
                <p className="text-gray-400 mb-6">
                  To subscribe to Premium features, please download our mobile app from the App Store.
                  Apple policies require all digital subscriptions to be purchased through the App Store.
                </p>
                <div className="flex justify-center">
                  <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-600 inline-block">
                    <p className="text-sm font-medium text-gray-300">Available on iOS & Android</p>
                  </div>
                </div>
              </div>
            )}
