...
import { Plus, TrendingUp, Target, Search, BarChart3, Drumstick, Wheat, Egg, Zap, Clock, ArrowLeftRight, Wallet, Settings, Mic, ChevronLeft, ChevronRight, ChevronDown, ScanBarcode, Trash2 } from 'lucide-react-native';
        ...
        {searchQuery.length > 2 && (
          <View style={dynamic.searchResults}>
            ...
            {isSearching ? (
              ...
              <View testID="home-search-results">
                {searchResults.slice(0, 8).map((item) => (
                  <View key={(item as FoodItem).id} style={dynamic.searchResultItem}>
              ...
              <View key={mealType} style={dynamic.mealAccordion}>
                ...
                {isExpanded && meals.length > 0 && (
                  <View style={dynamic.mealContent}>
                    {meals.map((meal) => (
                      <View key={meal.id} style={dynamic.mealItemRow}>
                        <View style={dynamic.mealItemTextWrap}>
                          <Text style={dynamic.mealItemName} numberOfLines={2}>
                            {meal.food_item.name}
                          </Text>
                        ...
                        <TouchableOpacity
                          ...
                          style={dynamic.mealDeleteBtn}
                          accessibilityLabel="Remove food from meal"
...
// Legacy style (no longer used for rows, kept in case other parts reference it)
mealItem: {
flexDirection: 'row',
justifyContent: 'space-between',
alignItems: 'center',
