  ...
  const PLANS = [
    {
      ...
      features: ['Basic journaling', '7 trades/month', 'Basic analytics'],
      highlighted: false,
    ...
    },
    {
      ...
      features: ['Unlimited trades', 'Advanced analytics', 'Trade screenshots'],
      highlighted: false,
    ...
    },
    {
      ...
      features: ['All Pro features', 'Priority support', 'Strategy testing'],
      highlighted: true,
      buttonText: 'Download App',
      tradeLimit: 'Unlimited trades',
      savings: 'Save 45%',
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {PLANS.map((plan, index) => (
              <div
                key={index}
                className={`relative p-8 rounded-xl border ${plan.highlighted
              ...
              >
                ...
                <button
                  ...
                  onClick={() => {
                    if (plan.name !== 'Free') {
                      alert('Please download our mobile app to subscribe to this plan.');
                    }
                  }}
                >
                  {plan.name === 'Free' ? (
                    <Link to={user ? "/" : "/signup"} className="block w-full h-full">
                      {plan.buttonText}
                    </Link>
                  ) : (
                    plan.buttonText
